...
typedef enum _LogMessage_CardTransaction_TransactionType {
    ...
    LogMessage_CardTransaction_TransactionType_DONATION = 4
...
typedef struct _LogMessage_Order {
    ...
    bool has_list_id;
    int32_t list_id;
    pb_callback_t crew_card_id;
} LogMessage_Order;

typedef PB_BYTES_ARRAY_T(7) LogMessage_CrewCardEnrollment_crew_card_id_t;
typedef struct _LogMessage_CrewCardEnrollment {
    LogMessage_CrewCardEnrollment_crew_card_id_t crew_card_id;
    int32_t valid_until;
...
typedef struct _LogMessage {
    ...
    int32_t usb_voltage;
    bool has_crew_card_enrollment;
    LogMessage_CrewCardEnrollment crew_card_enrollment;
} LogMessage;
...
#define _LogMessage_CardTransaction_TransactionType_MAX LogMessage_CardTransaction_TransactionType_DONATION
#define _LogMessage_CardTransaction_TransactionType_ARRAYSIZE ((LogMessage_CardTransaction_TransactionType)(LogMessage_CardTransaction_TransactionType_DONATION+1))
...
#define LogMessage_CardTransaction_transaction_type_ENUMTYPE LogMessage_CardTransaction_TransactionType

#define LogMessage_Order_payment_method_ENUMTYPE LogMessage_Order_PaymentMethod




/* Initializer values for message structs */
#define LogMessage_init_default                  {"", "", 0, 0, false, LogMessage_Order_init_default, false, LogMessage_CardTransaction_init_default, false, 0, false, 0, false, LogMessage_CrewCardEnrollment_init_default}
#define LogMessage_CardTransaction_init_default  {_LogMessage_CardTransaction_TransactionType_MIN, 0, 0, 0, 0, "", false, 0}
#define LogMessage_Order_init_default            {_LogMessage_Order_PaymentMethod_MIN, 0, {LogMessage_Order_CartItem_init_default, LogMessage_Order_CartItem_init_default, LogMessage_Order_CartItem_init_default, LogMessage_Order_CartItem_init_default, LogMessage_Order_CartItem_init_default, LogMessage_Order_CartItem_init_default, LogMessage_Order_CartItem_init_default, LogMessage_Order_CartItem_init_default, LogMessage_Order_CartItem_init_default}, false, 0, {{NULL}, NULL}}
#define LogMessage_Order_CartItem_init_default   {0, false, Product_init_default}
#define LogMessage_CrewCardEnrollment_init_default {{0, {0}}, 0}
#define LogMessage_init_zero                     {"", "", 0, 0, false, LogMessage_Order_init_zero, false, LogMessage_CardTransaction_init_zero, false, 0, false, 0, false, LogMessage_CrewCardEnrollment_init_zero}
...
#define LogMessage_CrewCardEnrollment_init_zero  {{0, {0}}, 0}
...
#define LogMessage_Order_crew_card_id_tag        4
#define LogMessage_CrewCardEnrollment_crew_card_id_tag 1
#define LogMessage_CrewCardEnrollment_valid_until_tag 2
...
#define LogMessage_crew_card_enrollment_tag      10
...
X(a, STATIC,   OPTIONAL, MESSAGE,  crew_card_enrollment,  10)
#define LogMessage_CALLBACK NULL
#define LogMessage_DEFAULT NULL
#define LogMessage_order_MSGTYPE LogMessage_Order
#define LogMessage_card_transaction_MSGTYPE LogMessage_CardTransaction
#define LogMessage_crew_card_enrollment_MSGTYPE LogMessage_CrewCardEnrollment
...
X(a, STATIC,   OPTIONAL, INT32,    counter,           7)
...
X(a, STATIC,   OPTIONAL, INT32,    list_id,           3) \
X(a, CALLBACK, OPTIONAL, BYTES,    crew_card_id,      4)
#define LogMessage_Order_CALLBACK pb_default_field_callback
...
#define LogMessage_CrewCardEnrollment_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BYTES,    crew_card_id,      1) \
X(a, STATIC,   SINGULAR, INT32,    valid_until,       2)
#define LogMessage_CrewCardEnrollment_CALLBACK NULL
#define LogMessage_CrewCardEnrollment_DEFAULT NULL
...
extern const pb_msgdesc_t LogMessage_CrewCardEnrollment_msg;
...
#define LogMessage_CrewCardEnrollment_fields &LogMessage_CrewCardEnrollment_msg

/* Maximum encoded size of messages (where known) */
/* LogMessage_size depends on runtime parameters */
/* LogMessage_Order_size depends on runtime parameters */
#define LOGMESSAGE_PB_H_MAX_SIZE                 LogMessage_CardTransaction_size
#define LogMessage_CardTransaction_size          73
#define LogMessage_CrewCardEnrollment_size       20
