 ...
 * https://github.com/luisfg30/rfid Which is an adaptation of the C++ Arduino library , available
 * at: https://github.com/miguelbalboa/rfid.git The original library is released to the public
 * domain.
 *
 */
...
enum PCD_Register {
  ...
  TestADCReg = 0x3B << 1        // shows the value of ADC I and Q channels
                                //               0x3C      //
                          // reserved for production tests               0x3D      // reserved for
                          // production tests               0x3E      // reserved for production
                          // tests
                          //               0x3F      //
